...
const ProductInfo = (props) => {
    return (
        <aside class="product-detail absolute right-0 top-0 w-1/4 h-9/10 bg-white">
            ...
            <div class="product-info px-5 pt-4 text-slate-500 h-full flex flex-col justify-between">
                <div>
